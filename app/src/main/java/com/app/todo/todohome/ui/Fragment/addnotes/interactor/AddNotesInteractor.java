...
public class AddNotesInteractor implements AddNotesInteractorInterface{
    ...
    public AddNotesInteractor(Context context, AddNotePresenter addNotePresenter) {
        ...
        try {
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    ...
                    List<NotesModel> li=new ArrayList<NotesModel>();
    ...
    public void putdata(int index, NotesModel notesModel) {
        ...
        ((AppCompatActivity)context).getFragmentManager().popBackStackImmediate();
    }
}
